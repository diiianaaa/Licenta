                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="name" class="form-control" required="" value="{{Auth::guard('admin')->user()->name}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="email" class="form-control" required="" value="{{Auth::guard('admin')->user()->email}}>
